...
import { getAllWarden2sApi, editWarden2Api } from '../../../api/api'

export default function EditWarden2() {
  const { id }   = useParams()
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await editWarden2Api(id, payload)
    ...
    <div style={s.page}>
      ...
      <div style={s.container}>
        ...
        <div style={s.pageHeader}>
          <h1 style={s.pageTitle}>Edit Warden 2</h1>
          <p style={s.pageSub}>Update gate warden details</p>
        </div>
