    ...
    <div style={s.page}>
      ...
      <div style={s.container}>
        ...
        <div style={s.pageHeader}>
          <div>
            <h1 style={s.pageTitle}>Warden 1s</h1>
            <p style={s.pageSub}>{wardens.length} review wardens</p>
          </div>
          <button
            style={s.addBtn}
...
const s = {
  ...
  addBtn:       { background: 'linear-gradient(135deg, #0891b2, #0e7490)', color: '#fff', border: 'none', padding: '12px 24px', borderRadius: '10px', cursor: 'pointer', fontWeight: '700', fontSize: '14px' },
  ...
  avatar:       { width: '48px', height: '48px', borderRadius: '50%', background: 'linear-gradient(135deg, #0891b2, #0e7490)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontWeight: '700', fontSize: '20px', flexShrink: 0 },
  cardInfo:     { flex: 1 },
